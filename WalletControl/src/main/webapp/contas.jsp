	...
	<section class="mt-5">
		<div class="container">
			...
			<form action="adicionar-listar" method="post">
				<div class="form-row">
					<div class="col">
						<button type="submit" class="botao-receita" name="adicionarConta">
							<img class="icons" src="img/bank.png" alt="Adicionar Conta">
							<h2>Adicionar Conta</h2>
						</button>
					</div>
					<div class="col">
						<button type="submit" class="botao-receita" name="listarContas">
							<img class="icons" src="img/lista-receitas.png"
								alt="Listar Receitas">
							<h2>Listar Contas</h2>
						</button>
					</div>
