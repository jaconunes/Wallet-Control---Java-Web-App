<%@page import="java.util.List"%>
    ...
    pageEncoding="UTF-8"%>
            ...
            <body class="bg-azul">
                ...
                <section>
                    <div class="container">
                        <form action="cadastrarDespesa" method="post" class="mb-5">
                            <div class="form-row">
                                ...
                                <div class="form-group col-md-4">
                                    ...
                                    <input type="date" class="form-control" id="inputPagamento" name="inputPagamento" placeholder="Pagamento" required>
                                </div>
                                <div class="form-group col-md-4">
                                    <label for="inputPagamentoEsperado">Data Pagamento Esperado</label>
                                    <input type="date" class="form-control" id="inputPagamentoEsperado" name="inputPagamentoEsperado" placeholder="Pagamento Esperado" required>
                                </div>
                            </div>
                            <div class="form-row">
