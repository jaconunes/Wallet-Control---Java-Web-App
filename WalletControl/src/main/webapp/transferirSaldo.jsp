                    ...
                    <form action="transferirSaldo" method="post" class="mb-5">
                        <%
                            ...
                            <div class="form-row">
                                ...
                                <div class="form-group col-md-6">
                                    <label for="inputSaldo">Saldo a Transferir:</label>
                                    <input type="number" step="0.01" min="0.01" class="form-control" id="inputSaldo" name="inputSaldo" placeholder="Saldo" required>
                                </div>
                            </div>
                            <button type="submit" class="btn btn-success" name="editar">Transferir Saldo</button>
