			...
			<div class="row">
				<div class="botoes text-center text-white col-md-4 col-12">
					<div class="botao bg-vermelho">
						<a href="receitas.jsp"> <img class="icons"
							src="img/receitas.png" alt="Receitas"> Receitas
						</a>
					</div>
				</div>
				<div class="botoes text-center text-white col-md-4 col-12">
					<div class="botao bg-vermelho">
						<a href="despesas.jsp"> <img class="icons"
							src="img/despesas.png" alt="Despesas"> Despesas
						</a>
					</div>
				</div>
				<div class="botoes text-center text-white col-md-4 col-12">
					<div class="botao bg-vermelho">
						<a href="contas.jsp"> <img class="icons" src="img/bank.png"
							alt="Contas"> Contas
						</a>
					</div>
				</div>
