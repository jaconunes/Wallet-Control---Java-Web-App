                            ...
                            %>
                                        <div class="form-row">
                                            <div class="form-group col-md-4">
                                                ...
                                                <input type="number" step="0.01" min="0.01" class="form-control" id="inputValor" name="inputValor" placeholder="Valor" value="<% out.print(receita.getValorReceita()); %>" required>
                                            </div>
                                            <div class="form-group col-md-4">
                                                <label for="inputRecebimento">Data Recebimento</label>
                                                <input type="date" class="form-control" id="inputRecebimento" name="inputRecebimento" placeholder="Recebimento" value="<% out.print(receita.getDataRecebimento()); %>" required>
                                            </div>
                                            <div class="form-group col-md-4">
                                                <label for="inputRecebimentoEsperado">Data Recebimento Esperado</label>
                                                <input type="date" class="form-control" id="inputRecebimentoEsperado" name="inputRecebimentoEsperado" placeholder="Recebimento Esperado" value="<% out.print(receita.getDataRecebimentoEsperado()); %>" required>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label for="inputDescricao">Descrição</label>
                                            <input type="text" class="form-control" id="inputDescricao" name="inputDescricao" placeholder="Descreva sua receita" value="<% out.print(receita.getDescricao()); %>" required>
                                        </div>
                                        <div class="form-row">
                                ...
                                <%}}%>                                
                                            ...
                                            <div class="form-group col-md-6">
                                                <label for="inputTipoReceita">Tipo de Receita</label>
                                                <select id="inputTipoReceita" class="form-control" name="inputTipoReceita" required>
                                <option class="text-dark"  selected><% out.print(receita.getTipoReceita()); %></option>
