                                ...
                                <form action="cadastrarReceita" method="post" class="mb-5">
                                    <div class="form-row">
                                        <div class="form-group col-md-4">
                                            ...
                                            <input type="number" step="0.01" min="0.01" class="form-control" id="inputValor" name="inputValor" placeholder="Valor" required>
                                        </div>
                                        <div class="form-group col-md-4">
                                            <label for="inputRecebimento">Data Recebimento</label>
                                            <input type="date" class="form-control" id="inputRecebimento" name="inputRecebimento" placeholder="Recebimento" required>
                                        </div>
                                        <div class="form-group col-md-4">
                                            <label for="inputRecebimentoEsperado">Data Recebimento Esperado</label>
                                            <input type="date" class="form-control" id="inputRecebimentoEsperado" name="inputRecebimentoEsperado" placeholder="Recebimento Esperado" required>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label for="inputDescricao">Descrição</label>
                                        <input type="text" class="form-control" id="inputDescricao" name="inputDescricao" placeholder="Descreva sua receita" required>
                                    </div>
                                    <div class="form-row">
